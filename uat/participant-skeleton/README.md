...
- `data/runs.csv` — the input the UAT's publish exercise cleans. Deliberately small, fixed, and
...
never vendored — see AGENTS.md, "The binaries that are still binaries".
